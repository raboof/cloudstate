...
import com.akkaserverless.protocol.event_sourced.{EventSourcedStreamIn, EventSourcedStreamOut}
...
trait EventingTCK extends TCKSpec {
  ...
  def verifyEventingProxy(): Unit = {
    ...
    "process json events" in eventLogSubscriptionTest {
      ...
      reply.value.events.head.typeUrl must startWith("json.akkaserverless.com/")
