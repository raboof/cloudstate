...
import com.akkaserverless.protocol.entity.{Entity, EntitySpec, ProxyInfo}
import com.akkaserverless.testkit.InterceptService.InterceptorSettings
import com.akkaserverless.testkit.{InterceptService, ServiceAddress, TestClient, TestProtocol}
...
object TCKSpec {
  ...
  object Settings {
    ...
    def fromConfig(config: Config): Settings = {
      val tckConfig = config.getConfig("akkaserverless.tck")
      Settings(
