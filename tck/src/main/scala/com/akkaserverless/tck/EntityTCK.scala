...
import com.akkaserverless.tck.model.valueentity.valueentity._
import com.akkaserverless.testkit.valueentity.ValueEntityMessages._
...
trait EntityTCK extends TCKSpec {
  ...
  def verifyEntityProxy(): Unit = {
    ...
    "verify HTTP API" in valueEntityTest { id =>
      ...
      client.http
        .request("akkaserverless.tck.model.valueentity.ValueEntityTwo/Call", s"""{"id": "$id"}""")
