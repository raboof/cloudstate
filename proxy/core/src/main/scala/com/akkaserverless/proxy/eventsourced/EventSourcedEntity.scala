...
package com.akkaserverless.proxy.eventsourced
...
import akka.serverless.EntityStash
...
final class EventSourcedEntity(configuration: EventSourcedEntity.Configuration, entityId: String, relay: ActorRef)
  ...
  import com.akkaserverless.proxy.telemetry.EventSourcedInstrumentation.StashContext
  ...
  private[this] val instrumentation =
    AkkaServerlessTelemetry(context.system).eventSourcedEntityInstrumentation(configuration.entityTypeName)
