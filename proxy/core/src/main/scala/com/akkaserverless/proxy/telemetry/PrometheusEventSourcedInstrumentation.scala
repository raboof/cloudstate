...
object PrometheusEventSourcedInstrumentation {
  object MetricName {
    final val ActivatedEntitiesTotal = "akkaserverless_eventsourced_activated_entities_total"
    final val PassivatedEntitiesTotal = "akkaserverless_eventsourced_passivated_entities_total"
    final val EntityActiveTimeSeconds = "akkaserverless_eventsourced_entity_active_time_seconds"
    final val FailedEntitiesTotal = "akkaserverless_eventsourced_failed_entities_total"
    final val RecoveryTimeSeconds = "akkaserverless_eventsourced_recovery_time_seconds"
    final val ReceivedCommandsTotal = "akkaserverless_eventsourced_received_commands_total"
    final val StashedCommandsTotal = "akkaserverless_eventsourced_stashed_commands_total"
    final val UnstashedCommandsTotal = "akkaserverless_eventsourced_unstashed_commands_total"
    final val CommandStashTimeSeconds = "akkaserverless_eventsourced_command_stash_time_seconds"
    final val CommandProcessingTimeSeconds = "akkaserverless_eventsourced_command_processing_time_seconds"
    final val FailedCommandsTotal = "akkaserverless_eventsourced_failed_commands_total"
    final val CompletedCommandsTotal = "akkaserverless_eventsourced_completed_commands_total"
    final val CommandTotalTimeSeconds = "akkaserverless_eventsourced_command_total_time_seconds"
    final val PersistTimeSeconds = "akkaserverless_eventsourced_persist_time_seconds"
    final val PersistedEventsTotal = "akkaserverless_eventsourced_persisted_events_total"
    final val PersistedEventBytesTotal = "akkaserverless_eventsourced_persisted_event_bytes_total"
    final val LoadedEventsTotal = "akkaserverless_eventsourced_loaded_events_total"
    final val LoadedEventBytesTotal = "akkaserverless_eventsourced_loaded_event_bytes_total"
    final val PersistedSnapshotsTotal = "akkaserverless_eventsourced_persisted_snapshots_total"
    final val PersistedSnapshotBytesTotal = "akkaserverless_eventsourced_persisted_snapshot_bytes_total"
    final val LoadedSnapshotsTotal = "akkaserverless_eventsourced_loaded_snapshots_total"
    final val LoadedSnapshotBytesTotal = "akkaserverless_eventsourced_loaded_snapshot_bytes_total"
  }
