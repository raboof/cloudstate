...
import com.akkaserverless.protocol.entity.{ClientAction, Failure}
import com.akkaserverless.protocol.event_sourced._
import com.akkaserverless.proxy.entity.{EntityCommand, UserFunctionReply}
import com.akkaserverless.proxy.eventsourced.{EventSourcedEntity, EventSourcedEntitySupervisor}
...
class EventSourcedInstrumentationSpec extends AbstractTelemetrySpec {
  ...
  "EventSourcedInstrumentation" should {
    ...
    "record event-sourced entity metrics" in withTestRegistry(
      ...
      implicit val registry: CollectorRegistry = AkkaServerlessTelemetry(system).prometheusRegistry
