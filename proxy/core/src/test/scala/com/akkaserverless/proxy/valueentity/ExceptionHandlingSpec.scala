...
import com.akkaserverless.proxy.TestProxy
import com.akkaserverless.proxy.test.thing.{Key, Thing, ThingClient}
import com.akkaserverless.testkit.TestService
import com.akkaserverless.testkit.valueentity.{TestValueEntityService, ValueEntityMessages}
...
class ExceptionHandlingSpec extends WordSpec with Matchers with BeforeAndAfterAll with ScalaFutures {
  ...
  "Akka Serverless proxy for Value Entity" should {
