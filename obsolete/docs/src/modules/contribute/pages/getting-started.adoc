...
...
scala> val client = new com.akkaserverless.samples.ShoppingCartClient("192.168.39.186", 32121)
Connecting to 192.168.39.186:32121
client: com.akkaserverless.samples.ShoppingCartClient = com.akkaserverless.samples.ShoppingCartClient@2c11e42a
